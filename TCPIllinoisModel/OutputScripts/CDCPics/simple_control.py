...
ax1.fill_between(data.t, levelzero, levelone, where=data.u_i<1250, color='black', alpha = 0.1, linewidth=0.0);
ax1.fill_between(data.t, levelzero, levelone, where=(data.u_i>=1250)*(data.u_i<1330), color='black', alpha = 0.2, linewidth=0.0);
ax1.fill_between(data.t, levelzero, levelone, where=(data.u_i>1330), color='black', alpha = 0.4, linewidth=0.0);
