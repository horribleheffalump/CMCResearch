...
ax1.plot(t, C1real, '-', color = 'red', alpha = 1, linewidth = 1.0)
ax1.plot(t, CI1, '-', color = 'magenta', alpha = 1, linewidth = 1.0)
ax1.plot(t, I1[:,0], '-', color = 'yellow', alpha = 1, linewidth = 1.0)
#print(R)
#print(G)
#print(data)
