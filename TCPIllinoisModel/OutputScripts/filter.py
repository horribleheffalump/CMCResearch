...
filename = u"../out/filter.txt"
t, p0, p1, p2, p3, u = np.loadtxt(filename, delimiter = ' ', usecols=(0,1,2,3,4,5), unpack=True, dtype=float)
...
ax3.plot(t, p0, color = 'blue')
ax3.plot(dhpoints.x, dhpoints.y, 'o', color = 'black')
ax3.plot(dlpoints.x, dlpoints.y, 'x', color = 'red')

ax2.plot(t, p1, color = 'blue')
ax1.plot(t, p2, color = 'blue')
ax0.plot(t, p3, color = 'blue')
