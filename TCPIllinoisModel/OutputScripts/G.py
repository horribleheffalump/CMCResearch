...
ax1.plot(t_RG, G[:,0], '-', color = 'red', alpha = 0.2, linewidth = 3.0)
ax1.plot(t_RG, G[:,1], '-', color = 'green', alpha = 0.4, linewidth = 3.0)
ax1.plot(t_RG, G[:,2], '-', color = 'blue', alpha = 0.6, linewidth = 3.0)
ax1.plot(t_RG, G[:,3], '-', color = 'black', alpha = 0.8, linewidth = 3.0)
