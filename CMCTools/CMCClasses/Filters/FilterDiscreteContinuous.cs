...
namespace CMC.Filters
{
    ...
    /// </summary>
    public class FilterDiscreteContinuous : Filter
    {
        ...
        public FilterDiscreteContinuous(int N, double t0, double T, double h, Func<double, double, Matrix<double>> A, Func<double, double, Vector<double>>[] c, List<SimultaneousJumpsIntencity>[] I, Func<double, double, Vector<double>> R, Func<double, double, Vector<double>> G, int SaveEvery = 0)
