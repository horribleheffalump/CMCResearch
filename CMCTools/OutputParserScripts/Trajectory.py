...
filename = u"../Output/trajectory.txt"
...
ax.fill_between(tplot, levelzero, levelone, where=Xplot==o, color='black', alpha = 0.2, linewidth=0.0);
ax.fill_between(tplot, levelone, leveltwo, where=Xplot==ones, color='black', alpha = 0.4, linewidth=0.0);
ax.fill_between(tplot, leveltwo, levelthree, where=Xplot==ones*2, color='black', alpha = 0.8, linewidth=0.0);

ax.plot(t, X, 'x', color = 'blue')
ax.plot(tplot, Xplot, color = 'black')
