...
plt.text(6.8, 5, r'$1/l^i$', fontdict = {'size' : 20})

ax.arrow(6.5, 11, 0, 2-0.55, head_width=0.2, head_length=0.5, fc='k', ec='k')
ax.arrow(6.5, 13-0.05, 0, -2+0.55, head_width=0.2, head_length=0.5, fc='k', ec='k')
plt.text(6.8, 13.3, r'$\tilde{v}^i$', fontdict = {'size' : 20})
